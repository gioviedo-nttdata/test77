                    ...
                    <div class="row page-title clearfix">
                        ...
                        <div class="page-title-right d-none d-sm-inline-flex">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Entrenadores
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 text-right">
                                            <div>
                                                ...
                                                <a id="bt_buscar1" rel="oculto" class="btn btn-primary btn-rounded ripple" style="color:#fff"><i class="fas fa-eye"></i> <span>&nbsp;Buscar Entrenadores</span></a>
                                            </div>

                                            <div id="buscador_div1" class="oculto">
                                                <form action="entrenadores.php" method="get">
                                    ...
                                    if (!empty($zipErrores)) { ?>
                                        <div class="col-md-12 paddsup">
                                            <div class="alert alert-danger" role="alert">
                                                ...
                                                <a href="Entrenadores_zip.php?valor=<?php echo $valor; ?>&origen=zip&disciplina=<?php echo $disciplina; ?>">Ver Registros</a>
                                            ...
                                            <tbody>
                                                <?php foreach ($users->row as $Elem) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $Elem['apellido'] . " " . $Elem['apellido2'].", ".$Elem['nombre']. "<br><strong>";
                                                         $lista = Cargo::getCargos($Elem['id']);
                                                         foreach ($lista as $item) {
                                                             echo $item['cargo']." - ";
                                                         }  
                                                         echo "</strong>";?></td>
                                                        <td><?php echo $Elem['clubN']. "<br>".Region::getRegion($Elem['regionN']). "<br><strong>";
                                                         $lista = Disciplina::getDisciplinas($Elem['id']);
                                                         foreach ($lista as $item) {
                                                        ...
                                                        <td>
                                                             ...
                                                             <a href="<?php echo BASE_PATH_CONTROL; ?>entrenadores_up.php?id=<?php echo $Elem['id']; ?>" class="btn mini" title="Documentacion" alt="Documentacion"><i class="fas fa-file-alt"></i></a>
                                        ...
                                        <div class="row1">
                                            <nav aria-label="Page navigation">
                                                <ul class="pagination">
                                                    ...
                                                    ?>
                                                    <?php if ($users->pag >= 1) { ?>
                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>entrenadores.php?pagi=1&<?php echo $listvar ?>">&laquo;</a></li>

                                                    <?php } ?>
                                                    <?php if ($users->pag > 1) { ?>

                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>entrenadores.php?pagi=<?php echo $PagAnt; ?>&<?php echo $listvar ?>">&lt;</a></li>
                                                    ...
                                                    ?>
                                                        <?php if ($users->pag == 1) { ?>
                                                            <li class="page-item<?php if ($contpag == $users->pag) { ?> active<?php } ?> <?php if ($contpag > 9) echo 'oculto'; ?>"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>entrenadores.php?pagi=<?php echo $contpag; ?>&<?php echo $listvar ?>"><?php echo $contpag; ?></a></li>
                                                        ...
                                                        ?>
                                                            <li class="page-item<?php if ($contpag == $users->pag) { ?> active<?php } ?> <?php if ($contpag > 7) echo 'oculto'; ?>">
                                                                <a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>entrenadores.php?pagi=<?php echo $contpag; ?>&<?php echo $listvar ?>"><?php echo $contpag; ?></a>
                                                            </li>
                                                        <?php
                                                            $contpag = $contpag + 1;
                                                    ...
                                                    <?php if ($users->pag < $users->total_pages) { ?>
                                                        ...
                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>entrenadores.php?pagi=<?php echo $PagSig; ?>&<?php echo $listvar ?>">&gt;</a></li>

                                                    <?php } ?>
                                                    <?php if ($users->pag >= 1) { ?>
                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>entrenadores.php?pagi=<?php echo $users->total_pages; ?>&<?php echo $listvar ?>">&raquo;</a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </nav>
