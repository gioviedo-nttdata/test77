                ...
                <div class="container-fluid">
                    <div class="row page-title clearfix">
                        <div class="page-title-left">
                            <h6 class="page-title-heading mr-0 mr-r-5">master
                            <?php if (!empty($club)) {
                                echo "del club: ".$elclub[0]['club'];
                            } ?> </h6>
                            <p class="page-title-description mr-0 d-none d-md-inline-block">Listado de master</p>
                        </div>
                        <!-- /.page-title-left -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 text-right">
                                            <div>
                                                ...
                                                <a id="bt_buscar1" rel="oculto" class="btn btn-primary btn-rounded ripple" style="color:#fff"><i class="fas fa-eye"></i> <span>&nbsp;Buscar master</span></a>
                                            </div>
                                                ...
                                                <?php foreach ($users->row as $Elem) { ?>
                                                    <tr>
                                                        <td><?php if (!empty($Elem['imagen'])) { ?>
                                                                <img src="/master/uploads/p_perfil_<?php echo $Elem['id']; ?>_<?php echo $Elem['imagen']; ?>.jpg" style="max-width: 70px;" alt="User Wall">
                                                            <?php } else { ?>
                                                        ...
                                                        <td><?php if ($Elem['pago']>0) { 
                                                            echo "<span class=\"verde\">Pagado</span>"; 
                                                             } else { 
                                                                 echo "<span class=\"rojo\">Pendiente</span><br>"; 
                                                                if ($Elem['comprobante']==1) {
                                                                    echo "<a href=\"/master/pagos/thumbnail_".$Elem['id']."_.jpg\" target=\"_blank\">Comprobante</a><br>"; 
                                                                } else {
                                                                    echo "<small>No enviado comprobante</small><br>";
                                                                }
                                                                    echo "<a href=\"master_aprobar.php?id=".$Elem['id']."\">Aprobar</a><br>";
                                                                 //
                                                                 }  ?>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?php echo BASE_PATH_CONTROL; ?>master_up.php?id=<?php echo $Elem['id']; ?>" class="btn mini" title="Documentacion" alt="Documentacion"><i class="fas fa-file-alt"></i></a>
                                        ...
                                        <div class="row1">
                                            <nav aria-label="Page navigation">
                                                <ul class="pagination">
                                                    ...
                                                    ?>
                                                    <?php if ($users->pag >= 1) { ?>
                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>master.php?pagi=1&<?php echo $listvar ?>">&laquo;</a></li>

                                                    <?php } ?>
                                                    <?php if ($users->pag > 1) { ?>

                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>master.php?pagi=<?php echo $PagAnt; ?>&<?php echo $listvar ?>">&lt;</a></li>
                                                    ...
                                                    ?>
                                                        <?php if ($users->pag == 1) { ?>
                                                            <li class="page-item<?php if ($contpag == $users->pag) { ?> active<?php } ?> <?php if ($contpag > 9) echo 'oculto'; ?>"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>master.php?pagi=<?php echo $contpag; ?>&<?php echo $listvar ?>"><?php echo $contpag; ?></a></li>
                                                        ...
                                                        ?>
                                                            <li class="page-item<?php if ($contpag == $users->pag) { ?> active<?php } ?> <?php if ($contpag > 7) echo 'oculto'; ?>">
                                                                <a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>master.php?pagi=<?php echo $contpag; ?>&<?php echo $listvar ?>"><?php echo $contpag; ?></a>
                                                            </li>
                                                        <?php
                                                            $contpag = $contpag + 1;
                                                    ...
                                                    <?php if ($users->pag < $users->total_pages) { ?>
                                                        ...
                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>master.php?pagi=<?php echo $PagSig; ?>&<?php echo $listvar ?>">&gt;</a></li>

                                                    <?php } ?>
                                                    <?php if ($users->pag >= 1) { ?>
                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>master.php?pagi=<?php echo $users->total_pages; ?>&<?php echo $listvar ?>">&raquo;</a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </nav>
