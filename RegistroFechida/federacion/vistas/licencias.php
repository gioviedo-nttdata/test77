                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 text-right">
                                            <div>
                                                ...
                                                <a href="<?php echo BASE_PATH_CONTROL; ?>licencias_down.php?<?php echo $listvar ?>" id="bt_buscar3" rel="oculto" class="btn btn-primary btn-rounded ripple" style="color:#fff"><i class="fas fa-download"></i> <span>&nbsp;Descargar Listado</span></a>
                                            </div>
