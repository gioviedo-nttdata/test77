                                                ...
                                                <?php foreach ($pases->row as $Elem) { ?>
                                                    <tr>
                                                         ...
                                                         <td><?php if (!empty($Elem['imagen'])) { ?>
                                                                <img src="/clubes/uploads/p_nadador_<?php echo $Elem['user']; ?>_<?php echo $Elem['imagen']; ?>.jpg" style="max-width: 70px;" alt="User Wall">
                                                            <?php } else { ?>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?php echo BASE_PATH_CONTROL; ?>pases_revisar.php?id=<?php echo $Elem['id']; ?>" class="btn btn-primary btn-rounded ripple" title="Documentacion" alt="Documentacion"><i class="fas fa-file-alt"></i> &nbsp;Documentación</a>
