                ...
                <div class="container-fluid">
                    <div class="row page-title clearfix">
                        <div class="page-title-left">
                            ...
                            <p class="page-title-description mr-0 d-none d-md-inline-block">Licencias pagas con transferencias</p>
                        </div>
                        <!-- /.page-title-left -->
                        <div class="page-title-right d-none d-sm-inline-flex">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Pagos pendientes
                        ...
                        <div class="col-md-12 widget-holder">
                            <div class="widget-bg">
                                <div class="widget-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 text-right">
                                            ...
                                            <div id="buscador_div1" class="oculto">
                                                <form action="licencias_pagadas.php" method="get">
                                    ...
                                    <h5 class="box-title">Pagos pendientes de aprobacion</h5>
                                        ...
                                        <table class="tablesaw color-table table-hover table tablesaw-stack table-striped tablesaw-row-zebra" data-tablesaw-mode="stack">
                                            ...
                                            <tbody>
                                                <?php foreach ($users->row as $Elem) { ?>
                                                    ...
                                                    <td><?php echo $Elem['fecin']; ?><br></td>
                                                    <td><?php if ($Elem['tipopago']=='2') { echo "Flow"; } else { echo "Transferencia"; } ?></td> 
                                                        <td><?php echo $Elem['monto'] ; ?></td>                                                      
                                                        <td>
                                                        <?php if ($Elem['tipopago']=='2') { echo $Elem['floworder']; } else { ?>
                                                             <a href="../clubes/pagos/thumbnail_<?php echo $Elem['id']; ?>_<?php echo $Elem['club']; ?>.jpg" class="btn mini" title="Documentacion" alt="Documentacion"><i class="fas fa-file-alt"></i></a>
                                                             <?php  } ?>
                                                            </td>
                                                        <td>
                                                             <a href="licencias_pago_atletas.php?id=<?php echo $Elem['id']; ?>" class="btn mini" title="Documentacion" alt="Documentacion">Ver atletas pagados</a><br>
                                        ...
                                        <div class="row1">
                                            <nav aria-label="Page navigation">
                                                <ul class="pagination">
                                                    ...
                                                    ?>
                                                    <?php if ($users->pag >= 1) { ?>
                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>licencias_pagadas.php?pagi=1&<?php echo $listvar ?>">&laquo;</a></li>

                                                    <?php } ?>
                                                    <?php if ($users->pag > 1) { ?>

                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>licencias_pagadas.php?pagi=<?php echo $PagAnt; ?>&<?php echo $listvar ?>">&lt;</a></li>
                                                    ...
                                                    ?>
                                                        <?php if ($users->pag == 1) { ?>
                                                            <li class="page-item<?php if ($contpag == $users->pag) { ?> active<?php } ?> <?php if ($contpag > 9) echo 'oculto'; ?>"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>licencias_pagadas.php?pagi=<?php echo $contpag; ?>&<?php echo $listvar ?>"><?php echo $contpag; ?></a></li>
                                                        ...
                                                        ?>
                                                            <li class="page-item<?php if ($contpag == $users->pag) { ?> active<?php } ?> <?php if ($contpag > 7) echo 'oculto'; ?>">
                                                                <a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>licencias_pagadas.php?pagi=<?php echo $contpag; ?>&<?php echo $listvar ?>"><?php echo $contpag; ?></a>
                                                            </li>
                                                        <?php
                                                            $contpag = $contpag + 1;
                                                    ...
                                                    <?php if ($users->pag < $users->total_pages) { ?>
                                                        ...
                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>licencias_pagadas.php?pagi=<?php echo $PagSig; ?>&<?php echo $listvar ?>">&gt;</a></li>

                                                    <?php } ?>
                                                    <?php if ($users->pag >= 1) { ?>
                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>licencias_pagadas.php?pagi=<?php echo $users->total_pages; ?>&<?php echo $listvar ?>">&raquo;</a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </nav>
