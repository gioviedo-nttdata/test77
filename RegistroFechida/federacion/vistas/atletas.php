                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 text-right">
                                            <div>
												...
												<a href="atletas_excel.php" class="btn btn-primary btn-rounded ripple" style="color:#fff"><i class="fas fa-download"></i> <span>&nbsp;Descargar Excel</span></a>
                                            </div>
                                            ...
                                            <tbody>
                                                <?php foreach ($users->row as $Elem) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo Funciones::fechaMostrar($Elem['fecnac'], 0); ?><br><?php
                                                        ...
                                                        <?php $cantDoc = Usuario::getCantDocumento($Elem['id']); ?>


                                                             <a href="<?php echo BASE_PATH_CONTROL; ?>nadadores_up.php?id=<?php echo $Elem['id']; ?>" class="btn mini" title="Documentacion" alt="Documentacion"style="<?php if ($cantDoc>0) { ?>color:#0000FF<?php } else { ?>color:#FF0000<?php } ?>"><i class="fas fa-file-alt"></i></a>
                                        ...
                                        <div class="row1">
                                            <nav aria-label="Page navigation">
                                                <ul class="pagination">
                                                    ...
                                                    ?>
                                                    <?php if ($users->pag >= 1) { ?>
                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>atletas.php?pagi=1&<?php echo $listvar ?>">&laquo;</a></li>

                                                    <?php } ?>
                                                    <?php if ($users->pag > 1) { ?>

                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>atletas.php?pagi=<?php echo $PagAnt; ?>&<?php echo $listvar ?>">&lt;</a></li>
                                                    ...
                                                    ?>
                                                        <?php if ($users->pag == 1) { ?>
                                                            <li class="page-item<?php if ($contpag == $users->pag) { ?> active<?php } ?> <?php if ($contpag > 9) echo 'oculto'; ?>"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>atletas.php?pagi=<?php echo $contpag; ?>&<?php echo $listvar ?>"><?php echo $contpag; ?></a></li>
                                                        ...
                                                        ?>
                                                            <li class="page-item<?php if ($contpag == $users->pag) { ?> active<?php } ?> <?php if ($contpag > 7) echo 'oculto'; ?>">
                                                                <a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>atletas.php?pagi=<?php echo $contpag; ?>&<?php echo $listvar ?>"><?php echo $contpag; ?></a>
                                                            </li>
                                                        <?php
                                                            $contpag = $contpag + 1;
                                                    ...
                                                    <?php if ($users->pag < $users->total_pages) { ?>
                                                        ...
                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>atletas.php?pagi=<?php echo $PagSig; ?>&<?php echo $listvar ?>">&gt;</a></li>

                                                    <?php } ?>
                                                    <?php if ($users->pag >= 1) { ?>
                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>atletas.php?pagi=<?php echo $users->total_pages; ?>&<?php echo $listvar ?>">&raquo;</a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </nav>
