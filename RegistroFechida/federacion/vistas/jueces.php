                ...
                <div class="container-fluid">
                    <div class="row page-title clearfix">
                        <div class="page-title-left">
                            <h6 class="page-title-heading mr-0 mr-r-5">Jueces
                            <?php if (!empty($club)) {
                                echo "del club: ".$elclub[0]['club'];
                            } ?> </h6>
                            <p class="page-title-description mr-0 d-none d-md-inline-block">Listado de Jueces</p>
                        </div>
                        <!-- /.page-title-left -->
                        <div class="page-title-right d-none d-sm-inline-flex">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Jueces
                            ...
                            <div class="widget-bg">
                                <div class="widget-body">
                                    <div class="row">
										...
										<?php if ($authj->rowff['nivel']>2) {  ?>
                                            <div>
                                                
                                                <a href="jueces_excel.php" class="btn btn-primary btn-rounded ripple" style="color:#fff"><i class="fas fa-download"></i> <span>&nbsp;Descargar excel</span></a> <a id="bt_buscar1" rel="oculto" class="btn btn-primary btn-rounded ripple" style="color:#fff"><i class="fas fa-eye"></i> <span>&nbsp;Buscar Jueces</span></a>
                                            </div>

                                            <div id="buscador_div1" class="oculto">
                                                <form action="jueces.php" method="get">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input class="form-control" id="email" name="email" placeholder="Email" type="text" value="<?php echo $nombre; ?>">
                                                        </div>
                                                    </div>
                                    ...
                                    <?php if (!empty($users->row)) { ?>
                                        <p>Registrados: <?php echo $users->total_results; ?> <br> Pagina: <?php echo $users->pag; ?> de <?php echo $users->total_pages; ?>
                                        </p>
                                                ...
                                                <?php foreach ($users->row as $Elem) { ?>
                                                    <tr>
                                                        <td><?php if (!empty($Elem['imagen'])) { ?>
                                                                <img src="/jueces/uploads/p_perfil_<?php echo $Elem['id']; ?>_<?php echo $Elem['imagen']; ?>.jpg" style="max-width: 70px;" alt="User Wall">
                                                            <?php } else { ?>
                                                                <img src="assets/demo/users/fotoperfil.jpg" style="max-width: 70px;" alt="User Wall">
                                                            <?php } ?></td>
                                                        <td><?php echo getPuntosRut($Elem['rut']); ?></td>
                                                        <td><?php echo $Elem['nombre']." ".$Elem['apellido'] . " " . $Elem['apellido2']; ?></td>
                                                        <td><?php echo Disciplina::getDisciplina($Elem['disciplina']); ?></td>
                                                        <td><?php echo $Elem['regionN']; ?><br><?php
														...
														unset($documentos1);
															...
															$documentos = $docu->getAll($Elem['id'], '1');
															$documentos1 = $docu->getAll($Elem['id'], '2');
															
															if (is_array($documentos)) {
																$contadocu = count($documentos);
																
															} else {
																$contadocu = 0;
															}
															if (is_array($documentos1)) {
																$contadocu1 = count($documentos1);
															...
															$totDocu = $contadocu+$contadocu1;
															?>


                                                            <a href="<?php echo BASE_PATH_CONTROL; ?>jueces_up.php?id=<?php echo $Elem['id']; ?>" class="btn mini" title="Documentacion" alt="Documentacion" style="<?php if ($totDocu>0) { ?>color:#0000FF<?php } else { ?>color:#FF0000<?php } ?>"><i class="fas fa-file-alt"></i></a>
                                        ...
                                        <div class="row1">
                                            <nav aria-label="Page navigation">
                                                <ul class="pagination">
                                                    ...
                                                    ?>
                                                    <?php if ($users->pag >= 1) { ?>
                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>jueces.php?pagi=1&<?php echo $listvar ?>">&laquo;</a></li>

                                                    <?php } ?>
                                                    <?php if ($users->pag > 1) { ?>

                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>jueces.php?pagi=<?php echo $PagAnt; ?>&<?php echo $listvar ?>">&lt;</a></li>
                                                    ...
                                                    ?>
                                                        <?php if ($users->pag == 1) { ?>
                                                            <li class="page-item<?php if ($contpag == $users->pag) { ?> active<?php } ?> <?php if ($contpag > 9) echo 'oculto'; ?>"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>jueces.php?pagi=<?php echo $contpag; ?>&<?php echo $listvar ?>"><?php echo $contpag; ?></a></li>
                                                        ...
                                                        ?>
                                                            <li class="page-item<?php if ($contpag == $users->pag) { ?> active<?php } ?> <?php if ($contpag > 7) echo 'oculto'; ?>">
                                                                <a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>jueces.php?pagi=<?php echo $contpag; ?>&<?php echo $listvar ?>"><?php echo $contpag; ?></a>
                                                            </li>
                                                        <?php
                                                            $contpag = $contpag + 1;
                                                    ...
                                                    <?php if ($users->pag < $users->total_pages) { ?>
                                                        ...
                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>jueces.php?pagi=<?php echo $PagSig; ?>&<?php echo $listvar ?>">&gt;</a></li>

                                                    <?php } ?>
                                                    <?php if ($users->pag >= 1) { ?>
                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>jueces.php?pagi=<?php echo $users->total_pages; ?>&<?php echo $listvar ?>">&raquo;</a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </nav>
