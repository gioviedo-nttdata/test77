                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($documentos as $Elem) { ?>
                                                            <tr>
                                                                <td><a href="entrenador_down.php?id=<?php echo $Elem['id'] ?>"><?php echo $Elem['nombre'] . "." . $Elem['extension']; ?></a></td>
                                                                <td>
                                    ...
                                    <div class="col-md-6 widget-holder">
                                        ...
                                        <div class="widget-bg">
                                            <div class="widget-body" id="docu_id2">
                                                <h5 class="box-title">Certificados de capacitaciones como entrenador agregados</h5>
