                                            ...
                                            <tbody>
                                                <?php foreach ($users->row as $Elem) { ?>
                                                    ...
                                                    <td><?php echo $Elem['fecin']; ?><br></td>
                                                        ...
                                                        <td>
                                                             <a href="licencias_pago_aprov.php?id=<?php echo $Elem['id']; ?>" class="btn mini" title="Documentacion" alt="Documentacion">Aprobar pago</a><br>
                                                             <a href="licencias_pago_rech.php?id=<?php echo $Elem['id']; ?>" class="btn mini" title="Documentacion" alt="Documentacion">Rechazar pago</a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
