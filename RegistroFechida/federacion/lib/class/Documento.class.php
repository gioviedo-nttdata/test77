	...
	public function agregar ($datosN = array())
    {
	   ...
	   if (empty($datosN['nombre'])) {
        ...
        public function getAll($id) {
            ...
            $db2 = Null;
                                        $db2 = Db::getInstance();
                                        $sql2 = "SELECT * FROM com_asociaciones_documentos WHERE asociacion = :asociacion ORDER BY id";
                                        $bind2 = array(
                                            ':asociacion' => $id
                                        );
        ...
        public function getDocumentoOne($id) {
            ...
            $db2 = Null;
                                        $db2 = Db::getInstance();
                                        $sql2 = "SELECT * FROM com_asociaciones_documentos WHERE id = :id LIMIT 1";
                                        $bind2 = array(
                                            ':id' => $id
                                        );
        ...
        public function guardarDoc($id, $valor, $nombre, $ext) {
			...
			$data = array(
                ...
                $db->insert('com_asociaciones_documentos', $data);
		//$this->id = $db->lastInsertId();
        ...
        public function elimDocu($id){
            $db = Db::getInstance();
            $db->delete('com_asociaciones_documentos', "competencia=:id" , array(':id' => $id));
