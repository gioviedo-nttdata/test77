...
class Usuario
{
    ...
    public function getLicenciasPagos($paginado = 1, $estado=0, $tipo=0, $periodo) {


        $db = Db::getInstance();

        $sql = "SELECT com_licencias_pago.*, com_clubes.id AS clubid, com_clubes.club AS clubN FROM com_licencias_pago LEFT JOIN com_clubes ON com_licencias_pago.club = com_clubes.id  WHERE com_licencias_pago.id > 0";
    ...
    public function getAllLicencias ($paginado = 1, $tipo = 'todos', $disciplina, $tipoLimit = '', $externo = 0, $opciones = array(), $club = '0', $periodo)
    {
        ...
        $sql = "SELECT DISTINCT com_users.id, com_licencias.fecin,  " . $this->tabla . ".*, com_especialidades.especialidad, com_clubes.club AS clubN,  com_clubes.region AS regionN FROM " . $this->tabla . " "
            . "LEFT JOIN com_especialidades ON com_users.disciplina = com_especialidades.id "
            . "LEFT JOIN com_clubes ON com_users.club = com_clubes.id "
