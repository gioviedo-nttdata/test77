...
if ($action == 'cemail') {
    ...
    $db = Db::getInstance();
				$sql = "SELECT * FROM com_jueces WHERE email = :email LIMIT 1";
    			$bind = array(
        		':email' => $email
    			);
...
//if ($resp->success) {
	...
	$db = Db::getInstance();
				...
				$db1 = Db::getInstance();
				$sql1 = "SELECT * FROM com_jueces WHERE rut = :rut LIMIT 1";
    			$bind1 = array(
        		':rut' => $rut
    			);
         ...
         <td valign=\"top\" align=\"left\">
             ...
             <tr>
              ...
              Apreciado/a  ".$nombre." ".$apellido." ".$apellido2."<br><br>
				Hemos recibido su solicitud de registro en el Sistema de Registro de Jueces de FECHIDA.<br>
...
$mail->FromName = "Registro de Jueces FECHIDA";

$mail->Subject = "Confirmacion de Registro de Jueces FECHIDA";

$mail->AltBody = "Confirmacion de Registro de Jueces FECHIDA";
$mail->IsHTML(true);
