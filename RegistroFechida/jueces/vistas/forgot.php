    ...
    <div id="wrapper" class="row wrapper">
        <div class="container-min-full-height d-flex justify-content-center align-items-center">
            <div class="login-center">
                <div class="navbar-header text-center mt-2 mb-4">
                    ...
                    <h6>Password Olvidado</h6>
                </div>
                <!-- /.navbar-header -->
                <form action="action_registro.php?action=forgot" method="post" id="form_login">
                    <?php if ($act=='OK' or $act=='rOK') { ?>
                <div class="col-md-12 paddsup">
                    <div class="alert alert-success" role="alert">
                      Hemos enviado un email con las instrucciones para recuperar el password. <br>Revise la bandeja de entrada de su correo electrónico  y haga clic en el enlace que aparece en el email que le hemos enviado.<br>En caso de que no aparezca en su bandeja principal , revise en la carpeta de "Correo no deseado".
                    </div>
          ...
          <div class="col-md-12 paddsup">
            <div class="alert alert-danger" role="alert">
              El email no está registrado en nuestra base de datos de clubes
            </div>          
          </div>
          <?php } else if ($err=='3') { ?>
          <div class="col-md-12 paddsup">
      ...
      <?php } else  if ($err=='5') { ?>
          ...
          <?php } ?>
                    ...
                    <div class="form-group">
                        <button class="btn btn-block btn-lg btn-primary text-uppercase fs-12 fw-600" type="submit">Recuperar</button>
                    </div>
                    <div class="form-group no-gutters mb-0">
                        <div class="col-md-12 d-flex">
                            ...
                            </div>--><a href="login.php" id="to-recover" class="my-auto pb-2 text-right"> Ingresas a su cuenta</a>
                        </div>
                        <!-- /.col-md-12 -->
                    </div>
                    <!-- /.form-group -->
