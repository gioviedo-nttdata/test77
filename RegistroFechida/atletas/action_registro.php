...
if ($action == 'cemail') {
    ...
    $db = Db::getInstance();
				$sql = "SELECT * FROM com_master WHERE email = :email LIMIT 1";
    			$bind = array(
        		':email' => $email
    			);
...
//if ($resp->success) {
	...
	$db = Db::getInstance();
				...
				$db1 = Db::getInstance();
				$sql1 = "SELECT * FROM com_master WHERE rut = :rut LIMIT 1";
    			$bind1 = array(
        		':rut' => $rut
    			);
        ...
        <tr>
         <td valign=\"top\" align=\"left\">
             ...
             <tr>
               <td width=\"15\" valign=\"top\" align=\"left\">&nbsp;</td>
               <td width=\"560\" align=\"left\" valign=\"top\"><font size=\"2\" color=\"#000000\" face=\"Arial, sans-serif\"><br /><br />
              Apreciado/a  ".$nombre." ".$apellido." ".$apellido2."<br><br>
				Hemos recibido su solicitud de registro en el Sistema de Registro de Atletas Master de FECHIDA.<br>
				Para confirmar su registro definitivo debe hacer clic sobre el siguiente enlace y completar el <b>pago de su Licencia (17.000 clp)</p>.<br>
				Acceder&aacute; a una p&aacute;gina de confirmaci&oacute;n en la web de Sistema de Registro FECHIDA.
...
$mail->FromName = "Registro de Master FECHIDA";

$mail->Subject = "Confirmacion de Registro Master FECHIDA";

$mail->AltBody = "Confirmacion de Registro de Master FECHIDA";
$mail->IsHTML(true);
