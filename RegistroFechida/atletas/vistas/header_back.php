...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo BASE_PATH_CONTROL; ?>favicon.png?v=2">
    ...
    <link href="<?php echo BASE_PATH_CONTROL; ?>assets/css/fullcalendar.min.css" rel="stylesheet" type="text/css">  
    ...
    <link href="<?php echo BASE_PATH_CONTROL; ?>assets/css/style.css?v=2.13" rel="stylesheet" type="text/css">
    <!-- Head Libs -->
