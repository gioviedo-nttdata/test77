                            ...
                            <div class="widget-body">
                                <div class="row">
                                    <div class="col-md-6 widget-holder">
                                        <h5 class="box-title">Agregar Carnet de Identidad <small>(todos los jueces)</small>  y Pasaporte <small>(solo jueces internacionales)</small> :</h5>
                                ...
                                <div class="row">
                                    <div class="col-md-6 widget-holder">
                                        <h5 class="box-title">Agregar Certificados de capacitaciones como juez/arbitro:</h5>
                                        <div class="formulario">
                                            <!-- /.box-header -->
                                            <!-- form start -->
