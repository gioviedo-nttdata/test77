...
if ($action == 'cemail') {
    ...
    $db = Db::getInstance();
				$sql = "SELECT * FROM com_clubes WHERE email = :email LIMIT 1";
    			$bind = array(
        		':email' => $email
    			);
...
//if ($resp->success) {
	...
	// primero revisamos que el email NO exista
		...
		$db = Db::getInstance();
				...
				$db1 = Db::getInstance();
				$sql1 = "SELECT * FROM com_clubes WHERE rut = :rut LIMIT 1";
    			$bind1 = array(
        		':rut' => $rut
    			);
         ...
         <td valign=\"top\" align=\"left\">
             ...
             <tr>
              ...
              Apreciado/a  ".$club."<br><br>
				Hemos recibido su solicitud de registro en el Sistema de Registro de Clubes de FECHIDA.<br>
...
$mail->FromName = "Registro de Clubes FECHIDA";

$mail->Subject = "Confirmacion de Registro de Clubes FECHIDA";

$mail->AltBody = "Confirmacion de Registro de Clubes FECHIDA";
$mail->IsHTML(true);
