                    ...
                    <div class="container-fluid">
						...
						<a id="bt_buscar" rel="oculto" class="btn btn-primary btn-rounded ripple" style="color:#fff"><i class="fas fa-eye"></i> <span>&nbsp;Iniciar Pase</span></a>
                                                ...
                                                <div id="buscador_div3" class="oculto">
                                                    ...
                                                    <div class="col-md-12">
                                                        <h5 align="left" class="box-title"><i>Recuerda que para dar Inicio al Pase debes adjuntar la siguiente Documentación</h5></i>
                                                        <div class="form-group row" align="left" id="div_requisitos">
                                                        </div>
                                                     </div>
                                                ...
                                                <?php foreach ($pases->row as $Elem) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php }else if($Elem['estatusid']=='4'){  ?>
                                                            <div  class="col-md-12 msg-iniciado"><b><?php echo $Elem['estatus']; ?></b></div>
                                                            <?php }else if($Elem['estatusid']=='5'){  ?>
                                                            <div  class="col-md-12 msg-incompletos"><b><?php echo $Elem['estatus']; ?></b></div>
                                                            <?php }else if($Elem['estatusid']=='6'){  ?>
                                                            <div  class="col-md-12 msg-por-revisar"><b><?php echo $Elem['estatus']; ?></b></div>
                                                           <?php }else if($Elem['estatusid']=='7'){  ?>
                                                            <div  class="col-md-12 msg-revisados"><b><?php echo $Elem['estatus']; ?></b></div>
                                                            <?php } ?>
                                                            </td>
                                                        ...
                                                        <td>
                                                           ...
                                                           <div class="padding-top5">
                                                            <a href="<?php echo BASE_PATH_CONTROL; ?>pases_up.php?id=<?php echo $Elem['id']; ?>" class="btn btn-primary btn-rounded ripple" title="Documentacion" alt="Documentacion"><i class="fas fa-file-alt">Documentacion</i></a>
                                                            </div>
                                                            <div class="padding-top5">
                                                            <?php if ($Elem['estatusid']>'2') { ?>
															<a href="<?php echo BASE_PATH_CONTROL; ?>pases_elim.php?id=<?php echo $Elem['id']; ?>" class="btn btn-primary btn-rounded ripple" title="Eliminar" alt="Eliminar" onClick="return confirm('Seguro de eliminar este pase?');"><i class="fa fa-fw fa-trash">Eliminar</i></a>
                                                            <?php } ?>
                                                             </div>
                                                        </td>
                                                    </tr>
