                                ...
                                <div class="widget-bg">
                                    <div class="widget-body">
                                        <div class="row">
                                            ...
                                            <?php //print_r($zipErroresOne); ?>
                                             
                                                
                                                <div id="buscador_div" class="oculto1">
                                                    ...
                                                    <input type="hidden" name="origen" value="<?php echo $origen?>">
                                                        <div class="row">
														  <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input class="form-control" id="ape1" name="ape1" placeholder="Apellido paterno" type="text" value="<?php echo $zipErroresOne[0]['apellido'] ?>" required>
                                                            </div>
                                                        </div>
														  </div>
														  <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input class="form-control" id="ape2" name="ape2" placeholder="Apellido Materno" type="text" value="<?php echo $zipErroresOne[0]['apellido2'] ?>" required>
                                                            </div>
															</div>
														  </div>
														  ...
														  <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input class="form-control" id="nombre" name="nombre" placeholder="Nombre" type="text" value="<?php echo $zipErroresOne[0]['nombre'] ?>" required>
                                                            </div>
															</div>
														  </div>
														  <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input class="form-control" id="rut" name="rut" placeholder="Rut" type="text" value="<?php echo $zipErroresOne[0]['rut'] ?>" required>
                                                            </div>
															</div>
														  </div>
														  ...
														  <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-8">
                                                                <select class="form-control" id="genero" name="genero" required>
                                                                    ...
                                                                    <option value="1"<?php if ($zipErroresOne[0]['genero'] == "1") { ?> selected<?php } ?>>Femenino</option>
                                                                    <option value="2"<?php if ($zipErroresOne[0]['genero'] == "2") { ?> selected<?php } ?>>Masculino</option>
                                                                </select>
                                                            </div>
															</div>
														  </div>
														  <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-8">
                                                               <input type="text" class="form-control datepicker" name="fecnac" id="fecnac" value="<?php echo $zipErroresOne[0]['fecnac'] ?>" required readonly>
														  ...
														  <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input class="form-control" id="email" name="email" placeholder="Email"<?php echo $zipErroresOne[0]['email'] ?> type="text">
                                                            </div>
															</div>
														  </div>
														</div>
                                        ...
                                        if (!empty($zipErrores)) { ?>
                                            <div class="col-md-12 paddsup">
                                                <div class="alert alert-danger" role="alert">
                                                    ...
                                                    <a href="nadadores_zip.php?valor=<?php echo $valor; ?>&origen=zip">Ver Registros</a>
