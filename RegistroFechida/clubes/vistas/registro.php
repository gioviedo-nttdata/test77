...
<body class="body-bg-full profile-page" style="background-image: url(assets/img/piscina1.jpg)">
    <div id="wrapper" class="row wrapper multi-step-signup">
        ...
        <?php if ($err=='7') { ?>
           ...
           <?php } else  if ($err=='5') { ?>
           <div class="alert alert-danger" role="alert">El RUT del Club que está intentado registrar ya está registrado en la base de datos. <br>
        ...
        <!-- /.step-tabs -->
              ...
              <option value="">Seleccionar Comuna*</option> </select>
                    ...
                    <div class="form-group">
                        <select class="form-control select2" name="asociacion" id="asociacion" autocomplete="off">
                          <option value=""> </option>
                          <?php
                          $db_pais1 = Null;
                    ...
                    $sql_pais1 = "SELECT * FROM com_asociaciones ORDER BY asociacion";
                      ...
                      ?>
                          <option value="<?php echo $row_pais['id'];?>"><?php echo ucwords (strtolower($row_pais['asociacion']));?></option>
                      <?php } ?>
                        </select>
                ...
                <!-- /.modal -->
                <div class="modal modal-primary fade bs-modal-lg-primary1" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel2" aria-hidden="true" style="z-index: 50000000;" >
                ...
                <footer class="col-sm-12 text-center">
                    <hr>
                    <p>Ya estás registrado? <a href="login.php" class="text-primary m-l-5"><b>Ingresa con tu password</b></a>
                    </p>
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function($) {
            ...
            $(".bs-modal-lg-primary1").modal("show");
        ...
        $('select.select2').select2({
            ...
            $("#region").change(function () {
                   $("#region option:selected").each(function () {
                    elegido=$(this).val();
                    console.log(elegido);
                    $.post("<?php echo BASE_PATH?>cargar_provincia.php", { region: elegido }, function(data){
                        ...
                        $this.find('.next-btn').on( "click", function(){
                            ...
                            var validator = form.validate({
                                ...
                                rut: {
                                  ...
                                  rut:true,
                                  remote: {
                                        url: "<?php echo BASE_PATH?>check_rut.php",
                                        type: "post",
                                        async: false,
                                        data: {
                                                rut: function() {
                                ...
                                email: {
                                      ...
                                      email: true,
                                  remote: {
                                        url: "<?php echo BASE_PATH?>check_email.php",
                                        type: "post",
                                        async: false,
                                        data: {
                                                rut: function() {
                                ...
                                messages: {
                                    ...
                                    presidente: {
                                        required: "Escriba el nombre del presidente del Club"
                                    },
                                    telefono: {
