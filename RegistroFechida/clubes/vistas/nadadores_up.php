            ...
            <div class="content-wrapper">
                ...
                <div class="widget-list row">
                    ...
                    <div class="col-md-6 widget-holder">
                        <h5 class="box-title">Agregar Certificado de Nacimiento o documento que acredite fecha de nacimiento: <?php echo $docu->row[0]['nombre']." ".$docu->row[0]['apellido']." ".$docu->row[0]['apellido2']?></h5>
                                ...
                                <div class="widget-body" id="docu_id">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <?php  foreach ($documentos as $Elem) { ?>
                                            <tr>
                                                <td><a href="documento_nadador_down.php?id=<?php echo $Elem['id']?>"><?php echo $Elem['nombre'].".".$Elem['extension'];?></a></td>
                                                <td>
