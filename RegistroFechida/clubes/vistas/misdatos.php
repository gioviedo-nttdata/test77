                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="widget-user-profile">
                                        ...
                                        <div class="profile-body">
                                            ...
                                            <h6 class="h3 profile-user-name"><?php echo $authj->rowff['club'];?></h6><small class="profile-user-address"><?php echo $roles;?></small>
							...
							<?php } ?>		
                                <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="form-control-label">Nombre del Club</label>
                                            <input class="form-control" id="club" name="club" placeholder="Nombre del Club" type="text" required="true" value="<?php echo $authj->rowff['club'];?>">
                                        </div>
                                       <div class="form-group">
										...
										<div class="form-group">
                                            <label class="form-control-label" for="l0">Comuna</label>        
											<div  id="dv_provincia">
												<select class="form-control" id="comuna" name="comuna" required="true">                                                 
													<?php foreach ($comunas as $Elem) { ?>
                                                    <option value="<?php echo $Elem['id'];?>"<?php if ($authj->rowff['comuna'] == $Elem['id']) { ?> selected<?php } ?>><?php echo $Elem['comuna'];?></option>
													<?php } ?>                                                    
                                                </select>
											</div>
                                        </div>
										...
										<div class="form-group">
                                            <label class="form-control-label" for="l0">Asociación</label>                                            
                                            <select class="form-control" id="asociacion" name="asociacion" required="true">
                                                 
													<?php foreach ($asociaciones as $Elem) { ?>
                                                    <option value="<?php echo $Elem['id'];?>"<?php if ($authj->rowff['asociacion'] == $Elem['id']) { ?> selected<?php } ?>><?php echo $Elem['asociacion'];?></option>
													<?php } ?>
