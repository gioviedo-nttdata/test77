                                ...
                                <div class="widget-bg">
                                    <div class="widget-body">
                                        <div class="row">
                                            ...
                                            <!--
                                                <div>
												    <a href="excel_down.php" class="btn btn-success btn-rounded ripple" style="color:#fff">Descargar Excel</a>
                                            ...
                                            -->
                                                ...
                                                <div id="buscador_div1" class="oculto">
                                                    <form action="nadadores_zip.php" method="post">
                                        ...
                                        if (!empty($zipErrores)) { ?>
                                            <div class="col-md-12 paddsup">
                                                <div class="alert alert-danger" role="alert">
                                                    ...
                                                    <a href="nadadores_zip?valor=<?php echo $valor; ?>&origen=zip">Ver Registros</a>
                                        ...
                                        <table class="tablesaw color-table table-hover table tablesaw-stack table-striped tablesaw-row-zebra" data-tablesaw-mode="stack">
                                            ...
                                            <tbody>
                                                <?php foreach ($zipErrores as $Elem) { ?>
                                                    <tr>
														<td><span class="roja" style="color: #FF0000"><?php echo $Elem['error']; ?></span></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?php echo BASE_PATH_CONTROL; ?>nadadores_agregar.php?id=<?php echo $Elem['id']; ?>&valor=<?php echo $valor; ?>&origen=zip&disciplina=<?php echo $disciplina; ?>" class="btn mini" title="Modificar datos" alt="Editar User"><i class="fas fa-user-edit"></i></a>
															<a href="<?php echo BASE_PATH_CONTROL; ?>nadadores_zip_elim.php?id=<?php echo $Elem['id']; ?>" class="btn mini" title="Eliminar" alt="Eliminar" onClick="return confirm('Seguro de eliminar este nadador?');"><i class="fa fa-fw fa-trash"></i></a>
                                        ...
                                        <div class="row1">
                                            <nav aria-label="Page navigation">
                                                <ul class="pagination">
                                                    ...
                                                    ?>
                                                    <?php if ($users->pag >= 1) { ?>
                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>nadadores_zip.php?pagi=1&<?php echo $listvar ?>">&laquo;</a></li>

<?php } ?>
<?php if ($users->pag > 1) { ?>

                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>nadadores_zip.php?pagi=<?php echo $PagAnt; ?>&<?php echo $listvar ?>">&lt;</a></li>
                                                    ...
                                                    <?php while ($contpag <= $users->total_pages) {
                                                        ?>
    <?php if ($users->pag == 1) { ?>
                                                            <li class="page-item<?php if ($contpag == $users->pag) { ?> active<?php } ?> <?php if ($contpag > 9) echo 'oculto'; ?>"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>nadadores_zip.php?pagi=<?php echo $contpag; ?>&<?php echo $listvar ?>"><?php echo $contpag; ?></a></li>
                                                        ...
                                                        elseif ($users->pag < 5) {
                                                            ...
                                                            <li class="page-item<?php if ($contpag == $users->pag) { ?> active<?php } ?> <?php if ($contpag > 7) echo 'oculto'; ?>"  >
                                                                <a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>nadadores_zip.php?pagi=<?php echo $contpag; ?>&<?php echo $listvar ?>"><?php echo $contpag; ?></a>
                                                            </li>
                                                            <?php
                                                            $contpag = $contpag + 1;
...
?>
                                                    <?php if ($users->pag < $users->total_pages) { ?>
                                                        ...
                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>nadadores_zip.php?pagi=<?php echo $PagSig; ?>&<?php echo $listvar ?>">&gt;</a></li>

<?php } ?>
<?php if ($users->pag >= 1) { ?>
                                                        <li class="page-item"><a class="page-link" href="<?php echo BASE_PATH_CONTROL; ?>nadadores_zip.php?pagi=<?php echo $users->total_pages; ?>&<?php echo $listvar ?>">&raquo;</a>
                                                        </li>
<?php } ?>
                                                </ul>
                                            </nav>
