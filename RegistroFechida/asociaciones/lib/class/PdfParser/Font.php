...
use PdfParser\Encoding\WinAnsiEncoding;
use PdfParser\Exception\EncodingNotFoundException;
...
class Font extends PDFObject
{
     ...
     * \PdfParser\PDFObject::factory() during file parsing (they would be just PDFObject).
     *
